...
function 예제1(){
	...
	/*		
		 AJAX : JQUERY 라이브러리에서 통신 함수 제공
			JQUERY : JS언어로 여러개 함수를 제공하는 라이브러리 집단
		1. 정의 : JS언어에서 외부와 통신하는 목적
		2. 형태 : $.ajax();
		3. 필수 : JQUERY 라이브러리 필수 <script src="https://code.jquery.com/jquery-latest.min.js" type="text/javascript"></script>
		4. 매개변수 : 객체 { 속성 : 값 , 속성 : 값 , 속성 : 값 }
			1. url속성 : 통신할 대상/링크/주소
			2. HTTP통신메소드 : post , get , put , delete 등등
			3. success결과속성 : 통신을 성공했을 때 반환된 데이터를 함수의 매개변수 반환 받음
