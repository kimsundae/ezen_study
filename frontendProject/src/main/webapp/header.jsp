<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<!--
		HTTP 상태 404 - 찾을 수 없음
				- 페이지 못찾았다[ 1.경로문제 2.오타 3.존재하지 않는파일 ]
				
		절대경로
			로컬 기준 C:\Users\504\frontendProject\src\main\webapp\index.jsp
			서버 기준 http://localhost:8080/frontendProject/index.jsp
			서버 기준 http://192.168.17.128:8080/frontendProject/index.jsp
				http://ip주소 : port번호
					- ip주소 : 컴퓨터 네트워크 식별번호	[ 집주소 ]
	  				- port번호 : 컴퓨터내 프로그램 식별번호 [ 8080 : HTTP 식별 ] [ 방번호 ]
	  			- /프로젝트명/(src->main->webapp생략) 폴더명 / 파일명
	  			
	  	상대경로 ( 헤더는 모든페이지 동일하게 작동 )
	  		./ : 현재폴더 ( 생략가능 )
	  		../ : 상위폴더 이동
	  		현재 파일 기준 [ ]
	  -->
