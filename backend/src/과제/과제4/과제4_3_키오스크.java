	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			if( ch == 1 ) {
				...
				System.out.println("총가격 : " + (사이다바구니*사이다가격 + 환타바구니*환타가격 + 콜라바구니*콜라가격));
				...
				if (num == 1) {
					...
					//결제 성공
					if(금액 - (사이다바구니*사이다가격 + 환타바구니*환타가격 + 콜라바구니*콜라가격) >= 0) {
						System.out.println("잔액 : " + (금액 - (사이다바구니*사이다가격 + 환타바구니*환타가격 + 콜라바구니*콜라가격)));						
					}
					//잔액부족
					else {
						System.out.println("잔액 부족.");
						사이다재고 += 사이다바구니; 환타재고 += 환타바구니; 콜라재고 += 콜라바구니;
					}
					사이다바구니 = 0; 환타바구니 = 0; 콜라바구니 = 0;
				}else if ( num == 2) {
