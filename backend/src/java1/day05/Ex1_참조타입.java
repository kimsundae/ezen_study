...
public class Ex1_참조타입 {
	...
	//  스택구역=힙구역
		...
		// 배열 { 1 , 2 , 3 } 을 생성 [ 힙영역에 메모리할당 ]하고 [ 할당된 주소를 ] 스택영역변수에 대입
		...
		// [p.151] 객체주소를 참조하고 있지 않는 상태 = null * 객체 ( 필드 , 메소드 ) 사용할 수 없는 상태
 ...
 * 			- 변수에 값 자체 저장X 변수에 힙 메모리 생성된 메모리를 참조 주소/번지 참조
 * 			- 첫글자가 대문자로 시작
 * 			String name = "신용권"
 * 
 * 
 ...
 * 	---------------------------------------------------------------------------
 * 									힙영역
 * 	아파트 유재석						103동 101호 [ 아파트 클래스로 객체/집 ]
 * 
 * ----------------------------------------------------------------------------
 *  
