...
public class Ex2_문자열 {
	...
	public static void main(String[] args) {
		...
		String firstNum = ssn2.substring(0,6); // 0번 인덱스부터 6번 인덱스 전까지 추출
...
/*
		...
		자바 문자열에서 제공해주는 라이브러리=미리 만들어진 함수들
			...
			2. 문자열객체.charAt ( 인덱스 )			: 문자열내 해당 인덱스의 문자1개 반환
			3. 문자열객체.length()
				vs 배열명.length
