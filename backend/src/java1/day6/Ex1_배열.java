...
public class Ex1_배열 {
	...
	public static void main(String[] args) { // main s
		...
		// 2. 호출
		System.out.println( season ); // season변수는 배열 주소값을 가지고 있는 스택영역
		...
		season[1] = null; // season[0] "summer" = "여름"
		System.out.println( Arrays.toString( season ));
				
		// 5. 추가 ( 없음 : 배열은 선언될 때 고정 ) * 인덱스 중에 null 있으면 해당위치에 데이터 추가
		...
		//	2. double형 배열
				...
				// 오류 이유 : Exception in thread "main" java.lang.ArrayIndexOutOfBoundsException: Index 3 out of bounds for length 3
		...
		//3. String 클래스 배열
				...
				for(int i = 0; i < arr3.length; i++) {
					if(arr3[i] == null) {// 만약에 i번째 인덱스의 값이 비어 있ㅇ므ㅕㄴ
