...
public class Ex1_조건문 {// class s
	...
	public static void main(String[] args) { // main s
		...
		switch(num) { // num 변수를 연결해서 제어
			...
			case 2 :	System.out.println("1나왔습니다."); break;
			case 3 :	System.out.println("1나왔습니다."); break;
			case 4 :	System.out.println("1나왔습니다."); break;
			case 5 :	System.out.println("1나왔습니다."); break;
			default : 	System.out.println("1나왔습니다.");
 ...
 * 				else if ( 조건식 2 ) { 참2 일 경우 실행문 }
 * 				else if ( 조건식 3 ) { 참3 일 경우 실행문 }
 * 				else { 거짓일 경우 실행문 }
 * 					* [ 다수 조건에 하나의 실행문 처리 ]
 * 			5
 * 				if( 조건식1 ) { 참1일 경우 실행문 }
