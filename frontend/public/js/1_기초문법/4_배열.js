/*
	변수 : 데이터 1개 저장할 수 있는 공간/메모리/상자 (수정가능)
		형태 : 선언키워드 변수명 = 데이터
		let 상자 = "물건"
		1. 선언키워드		:		let
		2. 변수명			:		상자
	...
	상수 : 데이터 1개 저장할 수 있는 공간/메모리/상자	(수정불가능)
		선언키워드 변수명 = 저장 할 데이터
		const 파란색상자	=	'연필'
...
document.write( 배열명 )
//	예제3 : 인덱스 사용 
document.write('<h3> 과일개수 : '+ 배열명.length + '</h3>' )// 변수or배열 문자처리x
...
배열명.splice( 배열명.indexOf('딸기') , 1 )//'딸기' 삭제 하는데 인덱스 번호를 모른상태
	// 1. 배열명.indexOf('딸기') => 2
