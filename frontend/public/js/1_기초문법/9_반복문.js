...
console.log('------- ex2 -------')	
let output = ``	// 문자열을 누적으로 저장할 output 변수 선언
...
console.log('-------ex4-------');
let sum = 0;	// 1부터 10깢 ㅣ누적으로 더한 값을 저장할 변수
for( let i = 1; i<= 10; i++){
	
	// 1. sum = sum+i
	// 2. sum+= i
	sum += i // (+=)	sum 변수에 i를 더한 값을 sum변수에 대입
} // for end
console.log(sum)
/* 예제4 순서도
	...
	for 시작
		i		조건		실행		누계			증감
		i = 1	i<=10 T	sum+=1	0+1=>1		i++
		i = 2	2<=10 T sum+=2	1+2=>3		i++
		i = 3	3<=10 T	sum+=3	3+3=>6		i++
		i = 4	4<=10 T sum+=4	6+4=>10		i++
		i = 5	5<=10 T sum+=5	10+5=>15	i++
		i = 6	i<=10 T	sum+=6	15+6=>21	i++
		i = 7	2<=10 T sum+=7	21+7=>28	i++
		i = 8	3<=10 T	sum+=8	28+8=>36	i++
		i = 9	4<=10 T sum+=9	36+9=>45	i++
		i = 10	5<=10 T sum+=10	45+10=>55	i++
		i = 11	11<=10 F 
*/
