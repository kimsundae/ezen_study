						...
						- 배열 단점 : 서로 다른 정보유형들을 하나의 배열에 관리 어렵다	
							ex) 유재석/강호동/신동엽 3명의 회원(정보: 아이디, 비밀번호 , 이름 , 주소 등) 등록
								...
								3방법 : 객체유형
									...
									let 회원2 = { 아이디 : 'qwe' , 비밀번호 : 'qwe' , 이름 : '유재석' , 주소 : '안산' }
									let 회원3 = { 아이디 : 'qwe' , 비밀번호 : 'qwe' , 이름 : '유재석' , 주소 : '안산' }									
...
console.log( '비밀번호속성 호출 : ' + 객체1.비밀번호 ) // 객체내 속성명 알고 있으면 데이터 호출 가능하다.
	...
	// document : 내장객체	-> document객체에서 quertySelector() 함수 호출
	// vs
console.log( 배열1[0])
// 3. 객체의 속성내 데이터 변경
...
// 6. 여러개의 동일한 유형의 객체유형 ( 속성명 ) 의 를 하나의 배열 저장
